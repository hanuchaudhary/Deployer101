/*
  ...
  - The values [ERROR] on the enum `DEPLOYMENT_STATUS` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "DEPLOYMENT_STATUS_new" AS ENUM ('PENDING', 'DEPLOYING', 'SUCCESS', 'FAILED', 'CANCELLED', 'QUEUED');
